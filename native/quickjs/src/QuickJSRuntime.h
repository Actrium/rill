...
struct CodeCacheItem {
  enum Result { UNINITIALIZED, INITIALIZED, REQUEST_UPDATE, UPDATED };
...
protected:
  ...
  getNativeState(const jsi::Object &) override;
  void setNativeState(const jsi::Object &,
  ...
  jsi::Object
  createObject(std::shared_ptr<jsi::HostObject> hostObject) override;
  std::shared_ptr<jsi::HostObject> getHostObject(const jsi::Object &) override;
  jsi::HostFunctionType &getHostFunction(const jsi::Function &) override;

  jsi::Value getProperty(const jsi::Object &,
                         const jsi::PropNameID &name) override;
  jsi::Value getProperty(const jsi::Object &, const jsi::String &name) override;
  bool hasProperty(const jsi::Object &, const jsi::PropNameID &name) override;
  bool hasProperty(const jsi::Object &, const jsi::String &name) override;
  void setPropertyValue(const jsi::Object &, const jsi::PropNameID &name,
                        const jsi::Value &value) override;
  void setPropertyValue(const jsi::Object &, const jsi::String &name,
                        const jsi::Value &value) override;
  ...
  void setValueAtIndexImpl(const jsi::Array &, size_t i,
                           const jsi::Value &value) override;
  ...
  jsi::Value call(const jsi::Function &, const jsi::Value &jsThis,
