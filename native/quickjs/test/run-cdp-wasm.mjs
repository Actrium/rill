...
dispatch(JSON.stringify({
    id: 2, method: "Debugger.setBreakpoint",
    params: { location: { scriptId: "guest.js", lineNumber: BP_CDP_LINE } },
}));
const bpResp = responseFor(2);
claim(2, bpResp && JSON.stringify(bpResp).includes("breakpointId"),
