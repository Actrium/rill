...
public:
  ...
  jsi::Value
  evaluateJavaScript(const std::shared_ptr<const jsi::Buffer> &buffer,
...
protected:
  ...
  jsi::PropNameID createPropNameIDFromAscii(const char *str,
  ...
  bool compare(const jsi::PropNameID & /*a*/,
               const jsi::PropNameID & /*b*/) override;
  ...
  jsi::String bigintToString(const jsi::BigInt & /*unused*/,
                             int /*unused*/) override;
  ...
  virtual std::shared_ptr<jsi::HostObject>
  getHostObject(const jsi::Object & /*obj*/) override;
  jsi::HostFunctionType &
  getHostFunction(const jsi::Function & /*obj*/) override;

  bool hasNativeState(const jsi::Object & /*obj*/) override;
  std::shared_ptr<jsi::NativeState>
  getNativeState(const jsi::Object & /*obj*/) override;
  void
  setNativeState(const jsi::Object & /*obj*/,
                 std::shared_ptr<jsi::NativeState> /*nativeState*/) override;

  jsi::Value getProperty(const jsi::Object & /*obj*/,
                         const jsi::String &name) override;
  jsi::Value getProperty(const jsi::Object & /*obj*/,
                         const jsi::PropNameID &name) override;
  bool hasProperty(const jsi::Object & /*obj*/,
                   const jsi::String &name) override;
  bool hasProperty(const jsi::Object & /*obj*/,
                   const jsi::PropNameID &name) override;
  void setPropertyValue(const jsi::Object & /*object*/, const jsi::String &name,
                        const jsi::Value &value) override;
  void setPropertyValue(const jsi::Object & /*object*/,
  ...
  void setValueAtIndexImpl(const jsi::Array & /*arr*/, size_t i,
                           const jsi::Value &value) override;

  jsi::Function
  createFunctionFromHostFunction(const jsi::PropNameID &name,
                                 unsigned int paramCount,
                                 jsi::HostFunctionType func) override;
  jsi::Value call(const jsi::Function & /*f*/, const jsi::Value &jsThis,
                  const jsi::Value *args, size_t count) override;
  jsi::Value callAsConstructor(const jsi::Function & /*f*/,
                               const jsi::Value *args, size_t count) override;
  ...
  void setExternalMemoryPressure(const jsi::Object & /*obj*/,
...
JSCRuntime::JSCRuntime(JSGlobalContextRef ctx)
    : ctx_(JSGlobalContextRetain(ctx)), ctxInvalid_(false)
#ifndef NDEBUG
      ,
...
std::shared_ptr<const jsi::PreparedJavaScript>
JSCRuntime::prepareJavaScript(const std::shared_ptr<const jsi::Buffer> &buffer,
...
jsi::Value
JSCRuntime::evaluateJavaScript(const std::shared_ptr<const jsi::Buffer> &buffer,
...
bool JSCRuntime::isInspectable() { return false; }

JSCRuntime::JSCSymbolValue::JSCSymbolValue(JSGlobalContextRef ctx,
...
JSCRuntime::JSCObjectValue::JSCObjectValue(JSGlobalContextRef ctx,
                                           const std::atomic<bool> &ctxInvalid,
                                           JSObjectRef obj
#ifndef NDEBUG
                                           ,
...
JSCRuntime::cloneSymbol(const jsi::Runtime::PointerValue *pv) {
  if (pv == nullptr) {
    return nullptr;
  }
...
jsi::Runtime::PointerValue *
JSCRuntime::cloneBigInt(const Runtime::PointerValue * /*pv*/) {
  throw std::logic_error("Not implemented");
}

jsi::Runtime::PointerValue *
JSCRuntime::cloneString(const jsi::Runtime::PointerValue *pv) {
  if (pv == nullptr) {
    return nullptr;
  }
...
jsi::PropNameID JSCRuntime::createPropNameIDFromAscii(const char *str,
                                                      size_t length) {
...
jsi::PropNameID JSCRuntime::createPropNameIDFromUtf8(const uint8_t *utf8,
                                                     size_t length) {
...
jsi::String JSCRuntime::bigintToString(const jsi::BigInt & /*unused*/,
                                       int /*unused*/) {
  throw std::logic_error("Not implemented");
}
...
jsi::String JSCRuntime::createStringFromUtf8(const uint8_t *str,
                                             size_t length) {
...
struct HostObjectProxyBase {
  HostObjectProxyBase(JSCRuntime &rt,
...
jsi::Object JSCRuntime::createObject(std::shared_ptr<jsi::HostObject> ho) {
  struct HostObjectProxy : public HostObjectProxyBase {
    static JSValueRef getProperty(JSContextRef ctx, JSObjectRef object,
                                  JSStringRef propName, JSValueRef *exception) {
...
#define JSC_UNUSED(x) (void)(x);
    ...
    static bool setProperty(JSContextRef ctx, JSObjectRef object,
                            JSStringRef propName, JSValueRef value,
...
JSCRuntime::getHostObject(const jsi::Object &obj) {
  ...
  auto metadata =
      static_cast<HostObjectProxyBase *>(JSObjectGetPrivate(object));
  assert(metadata);
...
bool JSCRuntime::hasNativeState(const jsi::Object &obj) {
  JSValueRef exc = nullptr;
  JSValueRef state = JSObjectGetPropertyForKey(ctx_, objectRef(obj),
                                               getNativeStateSymbol(), &exc);
  checkException(exc);
...
std::shared_ptr<jsi::NativeState>
JSCRuntime::getNativeState(const jsi::Object &obj) {
  JSValueRef exc = nullptr;
  JSValueRef state = JSObjectGetPropertyForKey(ctx_, objectRef(obj),
                                               getNativeStateSymbol(), &exc);
  checkException(exc);
...
void JSCRuntime::setNativeState(const jsi::Object &obj,
                                std::shared_ptr<jsi::NativeState> nativeState) {
  ...
  if (JSValueIsUndefined(ctx_, state)) {
    JSObjectRef stateObj =
        JSObjectMake(ctx_, getNativeStateClass(),
                     new NativeStateContainer(std::move(nativeState)));
    JSObjectSetPropertyForKey(ctx_, objectRef(obj), nativeStateSymbol, stateObj,
...
jsi::Value JSCRuntime::getProperty(const jsi::Object &obj,
...
bool JSCRuntime::hasProperty(const jsi::Object &obj,
                             const jsi::PropNameID &name) {
  JSObjectRef objRef = objectRef(obj);
  return JSObjectHasProperty(ctx_, objRef, stringRef(name));
}

void JSCRuntime::setPropertyValue(const jsi::Object &object,
                                  const jsi::PropNameID &name,
                                  const jsi::Value &value) {
  JSValueRef exc = nullptr;
  JSObjectSetProperty(ctx_, objectRef(object), stringRef(name), valueRef(value),
...
jsi::Array JSCRuntime::createArray(size_t length) {
  ...
  JSObjectSetProperty(ctx_, obj, getLengthString(),
                      JSValueMakeNumber(ctx_, static_cast<double>(length)), 0,
                      &exc);
  checkException(exc);
...
void JSCRuntime::setValueAtIndexImpl(const jsi::Array &arr, size_t i,
                                     const jsi::Value &value) {
  JSValueRef exc = nullptr;
  JSObjectSetPropertyAtIndex(ctx_, objectRef(arr), (int)i, valueRef(value),
                             &exc);
  checkException(exc);
}
...
public:
  ...
  jsi::HostFunctionType &getHostFunction() { return hostFunction_; }
...
jsi::Function
JSCRuntime::createFunctionFromHostFunction(const jsi::PropNameID &name,
                                           unsigned int paramCount,
  ...
  public:
    static void initialize(JSContextRef ctx, JSObjectRef object) {
      ...
      JSValueRef exc = nullptr;
      JSObjectSetProperty(ctx, object, getLengthString(),
      ...
      JSObjectSetProperty(
          ctx, object, getNameString(), JSValueMakeString(ctx, name),
    ...
    HostFunctionMetadata(JSCRuntime *rt, jsi::HostFunctionType hf, unsigned ac,
                         JSStringRef n)
        : HostFunctionProxy(hf), runtime(rt), argCount(ac),
...
public:
  ...
  operator JSValueRef *() { return outOfLine_ ? outOfLine_.get() : inline_; }
...
jsi::Value JSCRuntime::call(const jsi::Function &f, const jsi::Value &jsThis,
...
jsi::Value JSCRuntime::callAsConstructor(const jsi::Function &f,
                                         const jsi::Value *args, size_t count) {
  JSValueRef exc = nullptr;
  auto res = JSObjectCallAsConstructor(
      ctx_, objectRef(f), count, detail::ArgsConverter(*this, args, count),
      &exc);
  checkException(exc);
  return createValue(res);
}

bool JSCRuntime::strictEquals(const jsi::Symbol &a,
...
bool JSCRuntime::strictEquals(const jsi::BigInt &a,
...
bool JSCRuntime::strictEquals(const jsi::String &a,
                              const jsi::String &b) const {
  return JSStringIsEqual(stringRef(a), stringRef(b));
}

bool JSCRuntime::strictEquals(const jsi::Object &a,
...
void JSCRuntime::setExternalMemoryPressure(const jsi::Object & /*obj*/,
                                           size_t /*amount*/) {}

jsi::Runtime::PointerValue *
JSCRuntime::makeSymbolValue(JSValueRef symbolRef) const {
#ifndef NDEBUG
...
jsi::Runtime::PointerValue *
JSCRuntime::makeStringValue(JSStringRef stringRef) const {
...
jsi::Runtime::PointerValue *
JSCRuntime::makeObjectValue(JSObjectRef objectRef) const {
