...
| [指南](./guides/cli.zh.md) | [CLI](./guides/cli.zh.md) / [沙箱提供者](./guides/sandbox-providers.zh.md) / [原生集成](./guides/native-integration.zh.md) / [多租户](./guides/multi-tenant.zh.md) / [生产环境](./guides/production.zh.md) |
| [API](./api/README.zh.md) | [API 概览](./api/README.zh.md) / [Host API](./api/host.zh.md) / [Guest SDK](./api/sdk.zh.md) / [Orchestrator API](./api/orchestrator.zh.md) |
| [架构](./architecture/README.zh.md) | [概览](./architecture/README.zh.md) / [访客-宿主交互](./architecture/guest-host-interaction.zh.md) / [访客运行时](./architecture/guest-runtime.zh.md) / [桥接序列化](./architecture/bridge-serialization.zh.md) / [原生编排器](./architecture/native-orchestrator.zh.md) / [二进制协议](./architecture/binary-protocol.zh.md) / [安全性](./architecture/security.zh.md) / [事件总线](./architecture/event-bus.zh.md) / [CDP 调试](./architecture/cdp-debugging.zh.md) |
