async function createQuickJSSandbox(moduleArg = {}) {
  ...
  function findWasmBinary() {
    if (Module.locateFile) {
      return locateFile('quickjs-sandbox.wasm');
    }
    return new URL('quickjs-sandbox.wasm', import.meta.url).href;
  }
  ...
  function assignWasmExports(wasmExports) {
    ...
    _qjs_inject_json = Module._qjs_inject_json = wasmExports.p;
    _qjs_extract_json = Module._qjs_extract_json = wasmExports.q;
